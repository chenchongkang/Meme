...
//关闭connection
        ...
        var  userAddSql = 'INSERT INTO Entity_user(userID,userName,password,address,phoneNumber,avatar,qq,introduction) VALUES(3,?,?,?,?,"img",?,?)';
        var  userAddSql_Params = ['2','2','2','2','2','2'];
//增
